...
export const getPdaPoolAuthority = (
  programId: PublicKey
): {
  publicKey: PublicKey;
  nonce: number;
...
export const getCpmmPdaAmmConfigId = (
  programId: PublicKey,
  index: number
): {
  publicKey: PublicKey;
...
export const getCreatePoolKeys = ({
  programId,
  mintA,
  mintB,
}: {
